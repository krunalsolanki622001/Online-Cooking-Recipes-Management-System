...
class CIF_form_validation extends CI_Form_validation {
    ...
    function _execute($row, $rules, $postdata = NULL, $cycles = 0) {
        ...
        log_message('DEBUG', 'called Marwaelmanawy_form_validation::_execute ' . $row['field']);
...
/* End of file Marwaelmanawy_form_validation.php */
/* Location: ./application/libraries/Marwaelmanawy_form_validation.php */