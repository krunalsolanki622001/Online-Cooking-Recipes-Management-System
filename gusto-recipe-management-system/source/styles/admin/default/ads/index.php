<div class="page-title">
    <div class="breadcrumb-env">
        ...
        <ol class="breadcrumb bc-1" >
            ...
            <li class="active">
                <strong><?php echo lang('global_Advertisements') ?></strong>
            </li>
        </ol>
    </div>
</div>
...
<div class="panel panel-default">
    <div class="panel-heading">
        <h3 class="panel-title"> <?php echo lang('global_Advertisements') ?></h3>
        <div class="panel-options">
            <a href="<?php echo site_url('admin/ads/manage'); ?>" class="btn btn-secondary btn-sm" style="color:#fff"><i class="fa fa-plus-square" aria-hidden="true"></i> <?php echo lang('global_add_new_record') ?></a>
        </div>
    </div>
            ...
            <table cellspacing="0" class="table table-small-font table-bordered table-striped" >
                <thead>
                    <tr>
                        ...
                        <th><?php echo lang('global_type') ?></th>
                        <th><?php echo lang('global_Location') ?></th>
...
<script type="text/javascript">
    $(".remove").click(function () {
        ...
        {
            $.ajax({
                url: '<?php echo site_url() ?>admin/ads/delete/' + id,
                type: 'DELETE',
                error: function () {
