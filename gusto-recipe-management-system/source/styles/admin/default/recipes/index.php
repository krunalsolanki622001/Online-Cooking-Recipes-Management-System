<div class="page-title">
    <div class="breadcrumb-env">
        ...
        <ol class="breadcrumb bc-1" >
            ...
            <li class="active">
                <strong><?php echo lang('global_Recipes') ?></strong>
            </li>
        </ol>
    </div>
</div>
...
<div class="panel panel-default">
    <div class="panel-heading">
        <h3 class="panel-title"><?php echo lang('global_Recipes') ?></h3>
        <div class="panel-options">
            <a href="<?php echo site_url('admin/recipes/manage'); ?>" class="btn btn-secondary btn-sm" style="color:#fff"><i class="fa fa-plus-square" aria-hidden="true"></i> <?php echo lang('global_add_new_record') ?></a>
        </div>
    </div>
                    ...
                    <?php foreach ($items as $item): ?>
                        <tr id="<?php echo $item->recipe_id ?>">
                            ...
                            <?php if ($item->status == 'active'): ?>
                                <td><button class="btn btn-success btn-sm"> <?php echo lang('global_active') ?></button></td>
                            <?php else: ?>
                                <td><button class="btn btn-dart btn-sm"> <?php echo lang('global_inactive') ?></button></td>
                            <?php endif ?>
                            <td>
...
<script type="text/javascript">
    $(".remove").click(function () {
        ...
        {
            $.ajax({
                url: '<?php echo site_url() ?>admin/recipes/delete/' + id,
                type: 'DELETE',
                error: function () {
