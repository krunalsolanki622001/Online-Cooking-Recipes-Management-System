<div class="page-title">
    <div class="breadcrumb-env">
        ...
        <ol class="breadcrumb bc-1" >
            ...
            <li class="active">
                <strong><?php echo lang('global_Slide') ?></strong>
            </li>
        </ol>
    </div>
</div>
...
<div class="panel panel-default">
    <div class="panel-heading">
        <h3 class="panel-title"><?php echo lang('global_Slide') ?></h3>
    </div>
    <div class="panel-body">
        ...
        <form role="form" class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
            <div class="form-group">
                <label class="col-sm-2 control-label"><?php echo lang('global_Recipe') ?> <span class="required">*</span></label>
                <div class="col-sm-10">
                    <?php echo form_dropdown('recipe_id', dd2menu('recipes', array('recipe_id' => 'title')), set_value('recipe_id', $item->recipe_id ? $item->recipe_id : '5'), 'class="form-control s2example-1"') ?>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    ...
                    <a href="<?php echo site_url('admin/sliders/index'); ?>" class="btn btn-danger"><?php echo lang('global_cancel') ?></a>
                </div>
            </div>
        </form>
    </div>
