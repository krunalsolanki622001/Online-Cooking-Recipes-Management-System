...
<div class="panel panel-default">
    <div class="panel-heading">
        ...
        <div class="panel-options">
            <a href="<?php echo site_url('admin/tricks/manage'); ?>" class="btn btn-secondary btn-sm" style="color:#fff"><i class="fa fa-plus-square" aria-hidden="true"></i> <?php echo lang('global_add_new_record') ?></a>
        </div>
    </div>
...
<script type="text/javascript">
    $(".remove").click(function () {
        ...
        {
            $.ajax({
                url: '<?php echo site_url() ?>admin/tricks/delete/' + id,
                type: 'DELETE',
                error: function () {
