...
<div class="panel panel-default">
    <div class="panel-heading">
        ...
        <div class="panel-options">
            <a href="<?php echo site_url('admin/users/manage'); ?>" class="btn btn-secondary btn-sm" style="color:#fff"><i class="fa fa-user-plus" aria-hidden="true"></i>  <?php echo lang('global_add_new_record') ?></a>
        </div>
    </div>
            ...
            <table cellspacing="0" class="table table-small-font table-bordered table-striped" >
                <thead>
                    <tr>
                        ...
                        <th><?php echo lang('global_usergroup') ?></th>
                        <th><?php echo lang('global_status') ?></th>
                        <th><?php echo lang('global_created') ?></th>
                        <th><?php echo lang('global_Profile_Views') ?></th>
