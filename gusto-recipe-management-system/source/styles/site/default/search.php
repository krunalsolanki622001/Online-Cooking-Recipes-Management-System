...
<div class="container margin-top-35">
    <div class="row">
        ...
        <div class="clearfix"></div>
        <div class="col-md-12">
            <h3 class="headline"><?php echo lang('global_Search_Results') ?></h3>
            <span class="line margin-bottom-35"></span>
            <div class="clearfix"></div>
        </div>
        <div class="clearfix"></div>
        <div class="col-md-12">
            <div class="search-result-message"><?php echo lang('global_Search_Result_for') ?>: <b><?php echo set_value('title') ?> </b> <?php if (set_value('category_id')): ?> <?php echo lang('global_in_category') ?>: <b>  <?php echo $this->db->where("category_id", set_value('category_id'))->get("categories")->row()->title ?></b><?php endif ?></div>
            <?php if (!$items): ?>
                <div class="search-result-message error">
                    <?php echo lang('global_No_results_have_been_found_Try_different_word') ?>
                </div>
            <?php endif; ?>
        </div>
        <div class="clearfix"></div>
                    ...
                    <div class="col-md-3">
                        <div class="recipe-box">
                            ...
                            <div class="recipe-box-content">
                                <h3><a href="<?php echo site_url('recipe/' . urlencode($item->permalink)) ?>" title="<?php echo $item->title ?>"><?php echo ellipsize($item->title, 28) ?></a></h3>
